    ...
    <View style={styles.root}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.tagline}>Premium home cleaning · Raipur</Text>

          <View style={styles.bottom}>
            <View style={styles.progressTrack}>
              <Animated.View style={[styles.progressFill, { width: progressWidth }]} />
            </View>
            <Text style={styles.footer}>Trusted pros · Secure payments</Text>
          </View>
        </Animated.View>
      </View>
    </View>

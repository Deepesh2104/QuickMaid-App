...
import { PartnerHelpHeader } from '@/features/help/components/PartnerHelpHeader';
import { PartnerHelpReach } from '@/features/help/components/PartnerHelpReach';
...
export function PartnerHelpScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      >
        <PartnerHelpHeader paddingTop={insets.top} />
